...
# Create Retrieve Update Destroy
    def test_proposal_name(self):
        ...
        self.assertEqual(proposal_casper is not None, True )
        self.assertEqual(proposal_muffin is not None, True )

        self.assertEqual(proposal_casper.phone_number, "323-241-1122")
        self.assertEqual(proposal_muffin.phone_number, "423-241-1772")
